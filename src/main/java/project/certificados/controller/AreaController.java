...
public class AreaController {
    ...
    public Area getArea(@PathVariable("nombre") String nombre){
        return services.getArea(nombre);
    }
    ...
    public ResponseEntity<?> updateArea(@RequestBody(required = true) Area area){
        services.updateArea(area);
        return new ResponseEntity<>(HttpStatus.ACCEPTED);
    }
}
